...
from .autoencoder import checkpoint
# AudioSignal (Descript audiotools) - opzionale
try:
    from audiotools import AudioSignal  # pip install descript-audiotools
except Exception:
    AudioSignal = None  # fallback: usa torch.Tensor

# CQT discriminator (Audiocraft) - opzionale
try:
    from audiocraft.modules.discriminators.cqt_discriminator import CQTDiscriminator  # pip install audiocraft  # type: ignore
except Exception:
    CQTDiscriminator = None  # fallback: usa EncodecDiscriminator / altri
